function love.load()
    ...
    objects.boundaryTop = {}
    objects.boundaryTop.body = love.physics.newBody(world, 650/2, 5)
    objects.boundaryTop.shape = love.physics.newRectangleShape(650, 10)
    objects.boundaryTop.fixture = love.physics.newFixture(objects.boundaryTop.body, objects.boundaryTop.shape)

    objects.boundaryBottom = {}
    objects.boundaryBottom.body = love.physics.newBody(world, 650/2, 650-5)
    objects.boundaryBottom.shape = love.physics.newRectangleShape(650, 10)
    objects.boundaryBottom.fixture = love.physics.newFixture(objects.boundaryBottom.body, objects.boundaryBottom.shape)

    objects.boundaryLeft = {}
    objects.boundaryLeft.body = love.physics.newBody(world, 5, 650/2)
    objects.boundaryLeft.shape = love.physics.newRectangleShape(10, 650)
    objects.boundaryLeft.fixture = love.physics.newFixture(objects.boundaryLeft.body, objects.boundaryLeft.shape)

    objects.boundaryRight = {}
    objects.boundaryRight.body = love.physics.newBody(world, 650-5, 650/2)
    objects.boundaryRight.shape = love.physics.newRectangleShape(10, 650)
    objects.boundaryRight.fixture = love.physics.newFixture(objects.boundaryRight.body, objects.boundaryRight.shape)
